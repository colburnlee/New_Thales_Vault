const sportPositionalMarketDataContract = {
  abi: [
    ...
    {
      inputs: [
        { internalType: "address[]", name: "_marketBatch", type: "address[]" },
      ],
      ...
      outputs: [
        {
          ...
          internalType:
            "struct SportPositionalMarketData.SameGameParlayMarket[]",
          name: "sgpMarkets",
          type: "tuple[]",
        },
      ],
    ...
    {
      inputs: [
        { internalType: "address", name: "_mainMarket", type: "address" },
      ],
      ...
      outputs: [
        {
          ...
          internalType:
            "struct SportPositionalMarketData.ActiveMarketsLiquidity[]",
          name: "",
          type: "tuple[]",
        },
      ],
      ...
      outputs: [
        {
          ...
          internalType:
            "struct SportPositionalMarketData.MarketLiquidityAndPriceImpact",
          name: "",
          type: "tuple",
        },
      ],
    ...
    {
      inputs: [
        { internalType: "address", name: "_oddsObtainer", type: "address" },
      ],
      name: "setOddsObtainer",
      outputs: [],
      stateMutability: "nonpayable",
    ...
    {
      inputs: [
        { internalType: "address", name: "_voucherEscrow", type: "address" },
      ],
      name: "setVoucherEscrow",
      outputs: [],
      stateMutability: "nonpayable",
