  ...
  abi: [
    ...
    },
    {
      ...
      outputs: [
        {
          components: [
            { internalType: "bool", name: "vaultStarted", type: "bool" },
            {
            ...
            { internalType: "int256", name: "skewImpactLimit", type: "int256" },
            {
              internalType: "uint256",
...
module.exports = ammVaultContract;
